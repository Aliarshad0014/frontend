...
const ServicesCarousel: React.FC = () => {
  return (
    <div className="services-carousel-container">
      <h2 className='text-black'>Our Professional Services</h2>
      <Carousel
      ...
      >
        {[
          ...
          { name: 'Electrition', title: '', img: 'https://img.freepik.com/free-photo/male-electrician-works-switchboard-with-electrical-connecting-cable_169016-15204.jpg' },
          ...
          <div key={index} className="service-card text-black mb-40">
